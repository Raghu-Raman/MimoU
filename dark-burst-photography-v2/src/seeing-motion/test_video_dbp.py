...
if is_original == True:
	in_image=tf.compat.v1.placeholder(tf.float32,[None,None,None,3])
	gt_image=tf.compat.v1.placeholder(tf.float32,[None,None,None,3])

	out_image=Unet(in_image)

else:
	in_image = tf.compat.v1.placeholder(tf.float32, [None, 1, 918, 1374, 4])
	in_image_low = tf.compat.v1.placeholder(tf.float32, [None, 1, 459, 687, 4])
	in_flows = tf.compat.v1.placeholder(tf.float32, [None, 1, 459, 687, 2])
	gt_image = tf.compat.v1.placeholder(tf.float32, [None, None, None, 3])
