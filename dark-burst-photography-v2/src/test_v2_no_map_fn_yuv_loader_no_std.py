...
dataloader = Net_DataLoader(train_path="../../../dataset/penangTest/",
							valPath="../../../dataset/penangTest/", crop_size_h=-1,
							crop_size_w=-1,
							batch_size=1, normalize=True)
...
for data in test_loader:
	...
	ev04 = YUV420toYUV444((ev_04y_output + 1) * 255.0 / 2.0, (ev_04uv_output + 1) * 255.0 / 2.0)
